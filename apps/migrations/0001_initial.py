...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CarBrand',
            fields=[
                ('id', models.UUIDField(default=apps.models.base.GenRandomUUID(), editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=50)),
                ('logo', models.ImageField(upload_to='car/icons/brand_logo/%Y/%m/%d/')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=apps.models.base.GenRandomUUID(), editable=False, primary_key=True, serialize=False)),
                ('icon', models.ImageField(upload_to='car/icons/features/%Y/%m/%d/')),
                ('name', models.CharField(max_length=155)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='brand', to='apps.carbrand')),
                ('color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='color', to='apps.carcolor')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='type', to='apps.cartype')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.feature')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='car',
            name='features',
            field=models.ManyToManyField(through='apps.CarFeature', to='apps.feature'),
        ),
    ]
